...
const HeaderComponent = () => {
    ...
    return (
        ...
        <nav className="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8" aria-label="Global">
            <div className="flex lg:flex-1 flex-row w-full items-center align-center">
                <FingerPrintIcon
                    className="h-8 w-auto text-primary"
                />
                <span className="text-primary">Metrikard</span>
            </div>
            ...
            <div className="mt-6 flow-root">
                ...
                <div className="space-y-2 py-6">
                    <Disclosure as="div" className="-mx-3">
                        {({ open }) => (
                            <>
                                <Disclosure.Button className="flex w-full items-center justify-between rounded-lg py-2 pl-3 pr-3.5 text-base font-semibold leading-7 text-primary hover:bg-gray-700">
                                    Productos
                                    <ChevronDownIcon
                                ...
                                <Disclosure.Panel className="mt-2 space-y-2">
                                    ...
                                    <Disclosure.Button
                                        ...
                                        as="a"
                                        href={item.href}
                                        className="block rounded-lg py-2 pl-6 pr-3 text-sm font-semibold leading-7 text-primaryPressed hover:bg-gray-700"
                                    >
                                        {item.name}
                                    </Disclosure.Button>
                                    ))}
                    ...
                    <Link
                        href="/"
                        className="-mx-3 block rounded-lg px-3 py-2 text-base font-semibold leading-7 text-primary hover:bg-gray-700"
                    >
                        Features
                    </Link>
                    <Link
                ...
                <div className="py-6">
                    <Link
                        href="/"
                        className="-mx-3 block rounded-lg px-3 py-2.5 text-base font-semibold leading-7 text-primary hover:bg-gray-700"
                    >
                    Ingresar
                    </Link>
                </div>
